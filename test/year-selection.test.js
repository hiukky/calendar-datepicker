...
describe('Year Selection', () => {
  ...
  test('highlights the initial active year', () => {
    ...
    const activeYear = yearsChildren.find(child =>
  ...
  test('scrolls to active year', () => {
    const { yearsChildren, yearButton, yearSelector } = renderYearSelector(
      false,
    )
    const activeYear = yearsChildren.find(child =>
      child.classList.contains('-active'),
  ...
  test('selects a new year', () => {
    ...
    const nonSelectedYear = yearsChildren.find(
      child => !child.classList.contains('-active'),
    )
    const selectedYear = yearsChildren.find(child =>
      child.classList.contains('-active'),
    )
  ...
  test('navigates by keyboard', () => {
    ...
    const { getByText, yearSelectorWrapper } = renderYearSelector(true, {
      value,
    })
